...
Smithy spec pipeline, the in-development replacement for
deepgram/deepgram-go-sdk. It ships machine-generated wire types in
`api/` from spec-codegen-go and an idiomatic Go facade in `pkg/`
maintained by the spec-idiomatic agentic runner. Runs on Go 1.22+.
