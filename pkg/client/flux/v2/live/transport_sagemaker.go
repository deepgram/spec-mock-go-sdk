...
func (t sageMakerBidiBinding) connect(ctx context.Context, c *Client, opts *FluxLiveOptions) (wireStream, error) {
	...
	return sm.OpenStream(ctx, client, t.endpointName, "v2/listen", query, t.targetVariant, t.targetModel, t.inferenceID, t.enableExplanations, spectypes.MarshalFluxClientStream, spectypes.UnmarshalFluxServerStream)
}
