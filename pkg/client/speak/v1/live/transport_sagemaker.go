...
func (t sageMakerBidiBinding) connect(ctx context.Context, c *Client, opts *SpeakLiveOptions) (wireStream, error) {
	...
	return sm.ResilientDialBidi(ctx, t.cfg, sm.DefaultConfig(), t.endpointName, "v1/speak", query, t.targetVariant, t.targetModel, t.inferenceID, t.enableExplanations, spectypes.MarshalSpeakClientStream, spectypes.UnmarshalSpeakServerStream, isAckServerMessage)
}
...
func isAckServerMessage(m spectypes.SpeakServerStream) bool {
	switch m.(type) {
	case *spectypes.SpeakServerStreamMemberMetadata, *spectypes.SpeakServerStreamMemberAudioMetadata:
		return false
	default:
		return true
	}
