...
func (t sageMakerBidiBinding) connect(ctx context.Context, c *Client, opts *SpeakLiveOptions) (wireStream, error) {
	...
	return sm.OpenStream(ctx, t.client, t.endpointName, "v1/speak", query, t.targetVariant, t.targetModel, t.inferenceID, t.enableExplanations, spectypes.MarshalSpeakClientStream, spectypes.UnmarshalSpeakServerStream)
}
