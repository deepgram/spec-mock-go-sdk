...
func (t sageMakerBidiBinding) connect(ctx context.Context, c *Client, opts *LiveTranscriptionOptions) (wireStream, error) {
	...
	return sm.ResilientDialBidi(ctx, t.cfg, sm.DefaultConfig(), t.endpointName, "v1/listen", query, t.targetVariant, t.targetModel, t.inferenceID, t.enableExplanations, spectypes.MarshalClientStream, spectypes.UnmarshalServerStream, isAckServerMessage)
}
...
func isAckServerMessage(m spectypes.ServerStream) bool {
	switch m.(type) {
	case *spectypes.ServerStreamMemberMetadata, *spectypes.ServerStreamMemberError:
		return false
	default:
		return true
	}
