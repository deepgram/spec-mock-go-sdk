...
import (
	...
	utils "github.com/deepgram/spec-mock-go-sdk/tests/utils"
)
...
func TestDaily_Prerecorded_summary(t *testing.T) {
	t.Run("FromURL-Summarize", func(t *testing.T) {
		...
		t.Skip("summary v2 (FathomSummary.Short) not yet modeled in api/types; tracked as known divergence"); summary := ""
